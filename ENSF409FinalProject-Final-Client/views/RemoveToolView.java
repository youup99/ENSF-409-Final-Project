...
/**
 * This class creates the remove tool view.
 * @author Ethan Rigby
 * @since March 31, 2019
 */
public class RemoveToolView extends JFrame {
	
	/**
	 * Label for remove.
	 */
	private JLabel removeSup = new JLabel("Name/ID of Tool:");
